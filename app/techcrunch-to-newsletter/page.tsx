...
export default function TechcrunchToNewsletter() {
  return (
          ...
          <div className="flex flex-1 flex-col gap-6 p-6 pt-0">
            ...
            <div className="flex justify-between items-center flex-col sm:flex-row gap-4 sm:gap-0">
              ...
              <div className="flex items-center gap-2 flex-col sm:flex-row w-full sm:w-auto">
                <a 
                  href="https://tech-crunch-newsletter-generator.vercel.app"
                  target="_blank"
                ...
                <a 
                  href="https://github.com/harshith-eth/TechCrunch-Newsletter-Generator"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors text-sm w-full sm:w-auto"
                >
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Transform TechCrunch articles into professionally formatted newsletters instantly using AI-powered content generation. Built completely open source using the Firecrawl API for reliable article scraping.
              </p>
            </div>
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full flex flex-col">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Transform any TechCrunch article into a professional newsletter in seconds
                      </p>
                    </div>
                      ...
                      <div className="space-y-2.5">
                        <div className="flex gap-2.5 items-start group">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs leading-relaxed">Utilizes Firecrawl's powerful API to accurately extract article content, ensuring no data is missed - from text and images to metadata</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">🤖</div>
                          <div>
                            <h3 className="font-medium text-sm">AI-Powered Generation</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Azure OpenAI transforms raw content into engaging newsletters with perfect tone and structure while preserving key insights</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">📝</div>
                          <div>
                            <h3 className="font-medium text-sm">Professional Formatting</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Auto-generates compelling subject lines, introductions, key highlights, industry analysis and actionable takeaways</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">📋</div>
                          <div>
                            <h3 className="font-medium text-sm">Instant Newsletter Ready</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Copy your perfectly formatted newsletter with a single click - ready to be sent to your audience immediately</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full">
                    <div className="aspect-video flex items-center justify-center rounded-lg overflow-hidden">
                      <iframe
                        ...
                        src="https://www.youtube.com/embed/OCBTmKugEOY"
                        title="TechCrunch Newsletter Generator Demo"
                        frameBorder="0"
              ...
              <div className="flex-1">
                <div className="rounded-xl bg-white/30 backdrop-blur p-3.5 border border-white/20 space-y-3 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>The TechCrunch Newsletter Generator is a 100% open-source web application that transforms TechCrunch articles into professionally formatted newsletters using AI. Built with modern web technologies and designed with user experience in mind, this tool helps content creators, marketers, and tech enthusiasts create engaging newsletters in seconds.</p>
                    <p>At its core, the application leverages the powerful Firecrawl API for reliable and accurate article scraping. This ensures that all content from TechCrunch articles is properly extracted, including text, images, and metadata, before being processed by our AI system.</p>
                  </div>
                </div>
              </div>
            </div>
