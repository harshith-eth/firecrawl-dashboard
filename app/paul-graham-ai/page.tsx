...
export default function PaulGrahamAI() {
  return (
          ...
          <div className="flex flex-1 flex-col gap-6 p-6 pt-0">
            ...
            <div className="flex justify-between items-center flex-col sm:flex-row gap-4 sm:gap-0">
              ...
              <div className="flex items-center gap-2 flex-col sm:flex-row w-full sm:w-auto">
                <a 
                  href="https://paul-graham-ai.vercel.app/"
                  target="_blank"
                ...
                <a 
                  href="https://github.com/harshith-eth/paul-graham-ai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors text-sm w-full sm:w-auto"
                >
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                An AI-powered chatbot that lets you interact with Paul Graham's essays and wisdom in a natural, conversational way. Built with modern web technologies and powered by Firecrawl and Azure OpenAI.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full flex flex-col">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Chat with an AI trained on Paul Graham's essays and get startup insights in his style
                      </p>
                    </div>
                      ...
                      <div className="space-y-2.5">
                        <div className="flex gap-2.5 items-start group">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs leading-relaxed">Natural conversations about startups, programming, and life philosophy in PG's style</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs leading-relaxed">Get startup advice and insights using Azure OpenAI's advanced language models</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">📚</div>
                          <div>
                            <h3 className="font-medium text-sm">Essay Processing</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Real-time essay analysis and content processing using Firecrawl's API</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">🎨</div>
                          <div>
                            <h3 className="font-medium text-sm">Modern Interface</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Beautiful dark-themed UI with yellow accents and mobile-friendly design</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full">
                    <div className="aspect-video flex items-center justify-center rounded-lg overflow-hidden">
                      <iframe
                        ...
                        src="https://www.youtube.com/embed/weiUgvYHCTw"
                        title="Paul Graham AI Assistant Demo"
                        frameBorder="0"
              ...
              <div className="flex-1">
                <div className="rounded-xl bg-white/30 backdrop-blur p-3.5 border border-white/20 space-y-3 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow">
                  <h2 className="text-lg font-semibold">Tech Stack & Implementation</h2>
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>Built with React 18 and TypeScript for robust type safety, using Vite as the build tool for lightning-fast development. The beautiful UI is crafted with TailwindCSS and enhanced with Lucide React icons, featuring a dark-themed interface with yellow accents.</p>
                    <p>The application integrates Firecrawl's API for efficient essay content processing and Azure OpenAI for natural language generation. The project follows modern development practices with ESLint for code quality, PostCSS for advanced styling, and is deployed on Vercel for optimal performance.</p>
                  </div>
                </div>
              </div>
            </div>
