          ...
          <div className="flex flex-1 flex-col gap-6 p-6 pt-0">
            ...
            <div className="flex justify-between items-center flex-col sm:flex-row gap-4 sm:gap-0">
              ...
              <div className="flex items-center gap-2 flex-col sm:flex-row w-full sm:w-auto">
                <a 
                  href="https://chat-with-website-beta.vercel.app"
                  target="_blank"
                ...
                <a 
                  href="https://github.com/harshith-eth/chat-with-website"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors text-sm w-full sm:w-auto"
                >
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                An innovative AI-powered application that transforms any website into an interactive chatbot. Built using Firecrawl's powerful API and Azure OpenAI, this project demonstrates my ability to create impactful, user-centric applications.
              </p>
            </div>
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full flex flex-col">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Showcasing the power of Firecrawl's API through innovative features.
                      </p>
                    </div>
                      ...
                      <div className="space-y-2.5">
                        <div className="flex gap-2.5 items-start group">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs leading-relaxed">Instant website content analysis using Firecrawl's efficient crawling system</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs leading-relaxed">Azure OpenAI-powered chat interface for intuitive content interaction</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">🎨</div>
                          <div>
                            <h3 className="font-medium text-sm">Modern UI/UX</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Beautiful, responsive design with smooth animations and dark mode</p>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2.5 items-start group">
                          <div className="h-5 w-5 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium shrink-0 group-hover:scale-110 transition-transform">⚡</div>
                          <div>
                            <h3 className="font-medium text-sm">Technical Excellence</h3>
                            <p className="text-muted-foreground text-xs leading-relaxed">Built with React 18, TypeScript, and Vite for optimal performance</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-xl bg-white/30 backdrop-blur p-3 border border-white/20 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow h-full">
                    <div className="aspect-video flex items-center justify-center rounded-lg overflow-hidden">
                      <iframe
                        ...
                        src="https://www.youtube.com/embed/SwI-ktRxHZw"
                        title="Chat with Website Demo"
                        frameBorder="0"
              ...
              <div className="flex-1">
                <div className="rounded-xl bg-white/30 backdrop-blur p-3.5 border border-white/20 space-y-3 shadow-[0_2px_8px_-1px_rgba(249,115,22,0.05)] hover:shadow-[0_4px_12px_-1px_rgba(249,115,22,0.1)] transition-shadow">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>This project showcases my ability to leverage Firecrawl's powerful API to create innovative solutions. By combining Firecrawl's efficient web crawling capabilities with Azure OpenAI's language understanding, I've built a tool that transforms static websites into interactive knowledge bases.</p>
                    <p>The application demonstrates my expertise in modern web development, API integration, and creating seamless user experiences. It's a testament to my ability to build products that align with Firecrawl's mission of making web data more accessible and interactive.</p>
                  </div>
                </div>
              </div>
            </div>
